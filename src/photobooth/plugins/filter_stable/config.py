...
class FilterStableConfig(BaseConfig):
    model_config = SettingsConfigDict(title="Filter Stage StableDiffusion Plugin Config", json_file=f"{CONFIG_PATH}plugin_filter_stable.json")
